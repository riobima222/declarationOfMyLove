const paragraf = [
  ...
  `Hallo Mb Lina`,
  `saya gak tahu bagaimana cara terbaik memulai surat ini . jadi langsung aja ke intinya :`,
  ...
  `saya gak tahu kapan mulai mencintai mu , tapi yang pasti saat ini sudah terlalu dalam , seperti bukan cinta biasa , cinta yang selalu tumbuh , semakin besar setiap kali melihatmu.`,
  `saya belum bisa janji apa - apa , karena juga belum punya apa - apa , gak pengen ngajak pacaran , melanggar dan semacamnya.`,
  `saya ingin mencintaimu dengan cara yang paling terhormat , dengan kesiapan dan tanggung jawab`,
  `gak ada niat apa - apa selain hanya ingin kamu tahu & yang terpenting mendapat sebuah do'a.`,
  `kalo kamu gak keberatan , tolong selipkan di setiap do'a mu , do'akan semoga beberapa tahun kedepan Allah berikan rezeki yang cukup , do'akan bisa segera datang dan melamar mu dengan kesiapan yang cukup , merasa pantas bediri di samping mu , tanpa merasa rendah atau apapun.`,
  ...
  setTimeout(() => {
    ...
    const fadeIn = setInterval(() => {
      if (volume < 1) {
        ...
        music.volume = Math.min(volume, 0.08); // Pastikan tidak lebih dari 1
      } else {
